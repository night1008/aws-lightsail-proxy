export const shadowsocks_libev_method_options = [
...
export const lightsail_availability_zones = {
  ...
  'ap-northeast-2': [
    ...
    { value: 'ap-northeast-2d', label: 'ap-northeast-2d' },
  ],
  'ap-southeast-1': [
  ...
  'ca-central-1': [
    ...
    { value: 'ca-central-1c', label: 'ca-central-1c' },
    { value: 'ca-central-1d', label: 'ca-central-1d' },
  ],
  'eu-central-1': [
